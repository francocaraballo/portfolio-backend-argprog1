...
import com.portfolio.fnc.Dto.dtoExperiencia;
import com.portfolio.fnc.Entity.Experiencia;
import com.portfolio.fnc.Security.Controller.Mensaje;
import com.portfolio.fnc.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getDescripcionE(), dtoexp.getImagenUrl());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
         ...
         experiencia.setImagenUrl(dtoexp.getImagenUrl());
